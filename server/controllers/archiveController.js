const db = require('../database/db.js'); // Import koneksi database
...
exports.archiveNote = async (req, res) => {
  try {
    ...
    await db.query('INSERT INTO notes_archive (note_id, title, datetime, note) VALUES (?, ?, ?, ?)', [id, title, datetime, body]);
...
exports.restoreNote = async (req, res) => {
  try {
    ...
    await db.query('INSERT INTO notes (id, title, note, datetime) VALUES (?, ?, ?, ?)', [id, title, body, datetime]);
